...
static void DALI_ConfigCounter( void );
...
void DALI_ConfigInitTimer( void )
{
	...
	Timer_StartInterval_1ms(DALI_ConfigCounter);
}
...
* Return Value : none
******************************************************************************/
void DALI_ConfigStartTimer( uint16_t type )
{
	DI();
...
* Return Value : none
******************************************************************************/
void DALI_ConfigStopTimer( uint16_t type )
{
	DI();
...
******************************************************************************/
uint8_t DALI_IsConfigTimerRunning( uint16_t type )
{
	uint8_t ret = FALSE;
...
* Return Value : value
******************************************************************************/
void DALI_RegisterConfigTimer(uint16_t type, fn_t func)
{
	switch ( type ){
		case MS_4:
